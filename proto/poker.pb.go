...
var file_poker_proto_rawDesc = []byte{
	...
	0x72, 0x49, 0x44, 0x2a, 0xe1, 0x01, 0x0a, 0x0c, 0x50, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x41, 0x63,
	...
	0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x10, 0x08, 0x2a, 0xb9, 0x02, 0x0a, 0x09, 0x47, 0x61, 0x6d, 0x65,
	...
	0x64, 0x10, 0x0a, 0x32, 0xbd, 0x02, 0x0a, 0x0b, 0x50, 0x6f, 0x6b, 0x65, 0x72, 0x53, 0x65, 0x72,
...
var file_poker_proto_goTypes = []interface{}{
	...
	(*AckTokenRequest)(nil),   // 2: poker.AckTokenRequest
	(*AckTokenResponse)(nil),  // 3: poker.AckTokenResponse
	(*ActionOpts)(nil),        // 4: poker.ActionOpts
	(*RegisterRequest)(nil),   // 5: poker.RegisterRequest
	(*RegisterResponse)(nil),  // 6: poker.RegisterResponse
	(*JoinTableRequest)(nil),  // 7: poker.JoinTableRequest
	(*JoinTableResponse)(nil), // 8: poker.JoinTableResponse
	(*TakeTurnRequest)(nil),   // 9: poker.TakeTurnRequest
	(*TakeTurnResponse)(nil),  // 10: poker.TakeTurnResponse
	(*PlayRequest)(nil),       // 11: poker.PlayRequest
	(*ClientInfo)(nil),        // 12: poker.ClientInfo
	(*GameInfo)(nil),          // 13: poker.GameInfo
	(*GameData)(nil),          // 14: poker.GameData
}
var file_poker_proto_depIdxs = []int32{
	12, // 0: poker.AckTokenRequest.clientInfo:type_name -> poker.ClientInfo
	12, // 1: poker.RegisterRequest.clientInfo:type_name -> poker.ClientInfo
	0,  // 2: poker.RegisterRequest.playerAction:type_name -> poker.PlayerAction
	12, // 3: poker.JoinTableRequest.clientInfo:type_name -> poker.ClientInfo
	0,  // 4: poker.JoinTableRequest.playerAction:type_name -> poker.PlayerAction
	12, // 5: poker.TakeTurnRequest.clientInfo:type_name -> poker.ClientInfo
	0,  // 6: poker.TakeTurnRequest.playerAction:type_name -> poker.PlayerAction
	4,  // 7: poker.TakeTurnRequest.actionOpts:type_name -> poker.ActionOpts
	12, // 8: poker.PlayRequest.clientInfo:type_name -> poker.ClientInfo
	0,  // 9: poker.PlayRequest.playerAction:type_name -> poker.PlayerAction
	1,  // 10: poker.GameInfo.gameState:type_name -> poker.GameState
	13, // 11: poker.GameData.info:type_name -> poker.GameInfo
	2,  // 12: poker.PokerServer.AckToken:input_type -> poker.AckTokenRequest
	7,  // 13: poker.PokerServer.JoinTable:input_type -> poker.JoinTableRequest
	11, // 14: poker.PokerServer.Play:input_type -> poker.PlayRequest
	5,  // 15: poker.PokerServer.Register:input_type -> poker.RegisterRequest
	9,  // 16: poker.PokerServer.TakeTurn:input_type -> poker.TakeTurnRequest
	3,  // 17: poker.PokerServer.AckToken:output_type -> poker.AckTokenResponse
	8,  // 18: poker.PokerServer.JoinTable:output_type -> poker.JoinTableResponse
	14, // 19: poker.PokerServer.Play:output_type -> poker.GameData
	6,  // 20: poker.PokerServer.Register:output_type -> poker.RegisterResponse
	10, // 21: poker.PokerServer.TakeTurn:output_type -> poker.TakeTurnResponse
