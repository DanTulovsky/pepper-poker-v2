...
type GameInfo struct {
	...
	MaxPlayers int64  `protobuf:"varint,30,opt,name=maxPlayers,proto3" json:"maxPlayers,omitempty"`
	MinPlayers int64  `protobuf:"varint,40,opt,name=minPlayers,proto3" json:"minPlayers,omitempty"`
}
...
var file_poker_proto_rawDesc = []byte{
	...
	0x52, 0x07, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x49, 0x44, 0x22, 0x82, 0x01, 0x0a, 0x08, 0x47, 0x61,
	...
	0x14, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x49, 0x44, 0x12, 0x1e,
	0x0a, 0x0a, 0x6d, 0x61, 0x78, 0x50, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x73, 0x18, 0x1e, 0x20, 0x01,
	0x28, 0x03, 0x52, 0x0a, 0x6d, 0x61, 0x78, 0x50, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x73, 0x12, 0x1e,
	0x0a, 0x0a, 0x6d, 0x69, 0x6e, 0x50, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x73, 0x18, 0x28, 0x20, 0x01,
	...
	0x09, 0x52, 0x08, 0x70, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x49, 0x44, 0x2a, 0xb1, 0x01, 0x0a, 0x0c,
	...
	0x72, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x43, 0x61, 0x6c, 0x6c, 0x10, 0x03, 0x12, 0x15, 0x0a,
	0x11, 0x50, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x43, 0x68, 0x65,
	0x63, 0x6b, 0x10, 0x04, 0x12, 0x13, 0x0a, 0x0f, 0x50, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x41, 0x63,
	0x74, 0x69, 0x6f, 0x6e, 0x42, 0x65, 0x74, 0x10, 0x05, 0x12, 0x14, 0x0a, 0x10, 0x50, 0x6c, 0x61,
	0x79, 0x65, 0x72, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x46, 0x6f, 0x6c, 0x64, 0x10, 0x06, 0x32,
	0xfe, 0x01, 0x0a, 0x0b, 0x50, 0x6f, 0x6b, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x12,
...
var file_poker_proto_goTypes = []interface{}{
	...
	(*ActionOpts)(nil),        // 1: poker.ActionOpts
	(*RegisterRequest)(nil),   // 2: poker.RegisterRequest
	(*RegisterResponse)(nil),  // 3: poker.RegisterResponse
	(*JoinTableRequest)(nil),  // 4: poker.JoinTableRequest
	(*JoinTableResponse)(nil), // 5: poker.JoinTableResponse
	(*TakeTurnRequest)(nil),   // 6: poker.TakeTurnRequest
	(*TakeTurnResponse)(nil),  // 7: poker.TakeTurnResponse
	(*PlayRequest)(nil),       // 8: poker.PlayRequest
	(*ClientInfo)(nil),        // 9: poker.ClientInfo
	(*GameInfo)(nil),          // 10: poker.GameInfo
	(*GameData)(nil),          // 11: poker.GameData
}
var file_poker_proto_depIdxs = []int32{
	9,  // 0: poker.RegisterRequest.clientInfo:type_name -> poker.ClientInfo
	0,  // 1: poker.RegisterRequest.playerAction:type_name -> poker.PlayerAction
	9,  // 2: poker.JoinTableRequest.clientInfo:type_name -> poker.ClientInfo
	0,  // 3: poker.JoinTableRequest.playerAction:type_name -> poker.PlayerAction
	9,  // 4: poker.TakeTurnRequest.clientInfo:type_name -> poker.ClientInfo
	0,  // 5: poker.TakeTurnRequest.playerAction:type_name -> poker.PlayerAction
	1,  // 6: poker.TakeTurnRequest.actionOpts:type_name -> poker.ActionOpts
	9,  // 7: poker.PlayRequest.clientInfo:type_name -> poker.ClientInfo
	0,  // 8: poker.PlayRequest.playerAction:type_name -> poker.PlayerAction
	10, // 9: poker.GameData.info:type_name -> poker.GameInfo
	4,  // 10: poker.PokerServer.JoinTable:input_type -> poker.JoinTableRequest
	8,  // 11: poker.PokerServer.Play:input_type -> poker.PlayRequest
	2,  // 12: poker.PokerServer.Register:input_type -> poker.RegisterRequest
	6,  // 13: poker.PokerServer.TakeTurn:input_type -> poker.TakeTurnRequest
	5,  // 14: poker.PokerServer.JoinTable:output_type -> poker.JoinTableResponse
	11, // 15: poker.PokerServer.Play:output_type -> poker.GameData
	3,  // 16: poker.PokerServer.Register:output_type -> poker.RegisterResponse
	7,  // 17: poker.PokerServer.TakeTurn:output_type -> poker.TakeTurnResponse
